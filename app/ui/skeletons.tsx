...
export function InvoiceSkeleton() {
  return (
    <div className="flex flex-row items-center justify-between border-b border-gray-100 py-4 dark:border-gray-700">
...
export function TableRowSkeleton() {
  return (
    <tr className="w-full border-b border-gray-100 last-of-type:border-none dark:border-gray-700 [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
...
export function InvoicesMobileSkeleton() {
  return (
    <div className="mb-2 w-full rounded-md bg-white p-4 dark:bg-gray-800">
      <div className="flex items-center justify-between border-b border-gray-100 pb-8 dark:border-gray-700">
        <div className="flex items-center">
  ...
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-50 p-2 dark:bg-gray-800 dark:text-white md:pt-0">
          ...
          <table className="hidden min-w-full text-gray-900 dark:text-white md:table">
            <thead className="rounded-lg text-left text-sm font-normal dark:bg-gray-700 dark:text-white">
              <tr>
                <th
                  scope="col"
                  className="px-4 py-5 font-medium dark:text-gray-200 sm:pl-6"
                >
                  Customer
                </th>
                <th
                  scope="col"
                  className="px-3 py-5 font-medium dark:text-gray-200"
                >
                  Email
                </th>
                <th
